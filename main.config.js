const config = {
    ...
    links: {
        ...
        youtube: 'https://www.youtube.com/channel/UCLLPQfg2hKs9CFw3rfSLBkA',
        instagram: 'https://instagram.com/accretence',
        pinterest: 'https://pinterest.com/accretence',
        angelco: 'https://angel.co/u/accretence',
        behance: 'https://www.behance.net/Accretence',
        dribbble: 'https://dribbble.com/accretence',
        spotify:
            'https://open.spotify.com/user/6yltawl2tpxtkctgy1k8jjikx?si=15219de7471e45e4',
        reddit: 'https://reddit.com/u/accretence',
    },
    experiences: [
        {
            ...
            description:
                'As an academic student studying architecture, I helped transition a traditional design and construction company to a more contemporary and sustainable method of operation in a 6 months L&D program.',
        },
        {
        ...
        },
        {
            ...
            description:
                'Spent better part of 2 years on becoming a disciplined investor. Pretty self-explanatory.',
        },
    ],
    projects: [
        {
