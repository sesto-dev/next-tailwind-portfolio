          ...
          >
            <div className="flex gap-4">
              <div className="flex grow-0 shrink-0 justify-between w-20">
                ...
                <p className="font-normal text-xs dark:text-muted-foreground text-primary/80 ">
                  {exp.yearY}
                </p>
              </div>
              <div>
                <h4 className="leading-4 text-sm">
                  ...
                  {exp.setup === "Remote" && (
                    <span className="font-bold mx-1 border rounded-md bg-rose-700 text-background border-transparent dark:border-rose-700 text-xs p-[0.10rem] px-1">
                      REMOTE
                    </span>
                  )}
                  {exp.startup && (
                    <span className="font-bold mx-1 border rounded-md bg-cyan-500 text-background border-transparent dark:border-cyan-500 text-xs p-[0.10rem] px-1">
                      STARTUP
                    </span>
                  )}
                </h4>
